...
@timer "CPU cache setup" semi=SemidiscretizationHyperbolic(mesh, equations, initial_condition,
                                                           solver, boundary_conditions = boundary_condition_periodic)
@timer "GPU cache setup" semi_gpu=SemidiscretizationHyperbolicGPU(mesh, equations, initial_condition,
