...
# CUDA kernel for calculating symmetric fluxes and nonconservative fluxes in direction x
...
function symmetric_noncons_integral_kernel!(du, derivative_split, symmetric_flux_arr, noncons_flux_arr)
